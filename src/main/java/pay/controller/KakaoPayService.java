...
public class KakaoPayService {
	...
	public String kakaoPayReady(KakaoPayRequestVO req) {
        ...
        params.add("approval_url", "http://localhost:8083/KitchenNote/payment/kakaoPaySuccess.do");
        params.add("cancel_url", "http://localhost:8083/KitchenNote/payment/kakaoPayCancel.do");
        params.add("fail_url", "http://localhost:8083/KitchenNote/payment/kakaoPayFail.do");
